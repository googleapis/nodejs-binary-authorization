...
describe('v1beta1.BinauthzManagementServiceV1Beta1Client', () => {
    ...
    describe('getPolicy', () => {
        it('invokes getPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.GetPolicyRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.Policy());
            client.innerApiCalls.getPolicy = stubSimpleCall(expectedResponse);
            const [response] = await client.getPolicy(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getPolicy as SinonStub)
    ...
    describe('updatePolicy', () => {
        it('invokes updatePolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.UpdatePolicyRequest());
            request.policy = {};
            request.policy.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updatePolicy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createAttestor', () => {
        it('invokes createAttestor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.CreateAttestorRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.Attestor());
            client.innerApiCalls.createAttestor = stubSimpleCall(expectedResponse);
            const [response] = await client.createAttestor(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createAttestor as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getAttestor', () => {
        it('invokes getAttestor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.GetAttestorRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAttestor as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateAttestor', () => {
        it('invokes updateAttestor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.UpdateAttestorRequest());
            request.attestor = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateAttestor as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteAttestor', () => {
        it('invokes deleteAttestor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.DeleteAttestorRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteAttestor as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listAttestors', () => {
        it('invokes listAttestors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.ListAttestorsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAttestors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('Path templates', () => {
        ...
        describe('policy', () => {
            ...
            client.initialize();
            client.pathTemplates.policyPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.policyPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('policyPath', () => {
                const result = client.policyPath("projectValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.policyPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromPolicyName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.policyPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
