...
describe('v1.ValidationHelperV1Client', () => {
    ...
    describe('validateAttestationOccurrence', () => {
        it('invokes validateAttestationOccurrence without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.ValidateAttestationOccurrenceRequest());
            request.attestor = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.ValidateAttestationOccurrenceResponse());
            ...
            assert((client.innerApiCalls.validateAttestationOccurrence as SinonStub)
