...
describe('v1.BinauthzManagementServiceV1Client', () => {
    ...
    describe('getPolicy', () => {
        it('invokes getPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.GetPolicyRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.Policy());
    ...
    describe('updatePolicy', () => {
        it('invokes updatePolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.UpdatePolicyRequest());
            request.policy = {};
            request.policy.name = '';
    ...
    describe('createAttestor', () => {
        it('invokes createAttestor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.CreateAttestorRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.Attestor());
    ...
    describe('updateAttestor', () => {
        it('invokes updateAttestor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.UpdateAttestorRequest());
            request.attestor = {};
    ...
    describe('deleteAttestor', () => {
        it('invokes deleteAttestor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.DeleteAttestorRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listAttestors', () => {
        it('invokes listAttestors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.ListAttestorsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
