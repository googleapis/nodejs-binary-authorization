...
describe('v1.SystemPolicyV1Client', () => {
    it('has servicePath', () => {
        const servicePath = systempolicyv1Module.v1.SystemPolicyV1Client.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = systempolicyv1Module.v1.SystemPolicyV1Client.apiEndpoint;
        assert(apiEndpoint);
    });
    ...
    describe('getSystemPolicy', () => {
        it('invokes getSystemPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.GetSystemPolicyRequest());
            request.name = '';
            ...
            assert((client.innerApiCalls.getSystemPolicy as SinonStub)
